...
import * as QuizManagementService from '~/services/admin/quiz.management.service';
const active_type = {
    CHANGE_DISABLED: 'CHANGE_DISABLED',
    SET_QUIZZES_LIST: 'SET_USER_LIST',
};
const quizManageReducer = (state, action) => {
    switch (action.type) {
...
const QuizManagement = () => {
    ...
    const getQuizListMutation = useMutationHooks((data) => QuizManagementService.getQuizList(data));
    useEffect(() => {
    ...
    const changeQuizDisabledMutation = useMutationHooks((data) => QuizManagementService.changeQuizDisabled(data));
